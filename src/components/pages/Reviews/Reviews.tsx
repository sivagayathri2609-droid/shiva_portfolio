...
const reviews = [
  { name: "Alex Morgan",    role: "Product Manager",          text: "Siva is an exceptional UX/UI designer who truly understands user needs. Her designs are clean, modern, and highly impactful." },
  { name: "Priya Sharma",   role: "Founder, HealthTech",      text: "Working with Siva was a fantastic experience. She delivered high-quality designs on time and was open to feedback throughout." },
  { name: "Daniel Lewis",   role: "CEO, Novaride",            text: "Siva has a great eye for detail and a strong design sense. She is proactive, creative, and always goes the extra mile to deliver." },
  { name: "Sara Johnson",   role: "Head of Product, Finly",   text: "Her ability to translate complex requirements into intuitive UI is remarkable. The final product exceeded all our expectations." },
  { name: "Ravi Kumar",     role: "Startup Founder",          text: "Siva designed our entire app from scratch. The attention to detail and quality of work was outstanding. Highly recommend!" },
  { name: "Emily Chen",     role: "UX Lead, TechCorp",        text: "A true professional. Siva's designs are always pixel-perfect, well-documented, and developer-friendly. A pleasure to work with." },
  { name: "James Patel",    role: "Co-founder, Eventro",      text: "Siva brought our vision to life beautifully. Her research-driven approach ensured users loved the product from day one." },
  { name: "Maria Gonzalez", role: "Creative Director",        text: "Incredibly talented designer with a strong eye for aesthetics. She delivered on time and maintained great communication throughout." },
  { name: "Liam Thompson",  role: "CTO, Buildify",            text: "Siva's design systems are scalable and thoughtfully structured. She made developer handoff seamless and reduced build time significantly." },
]
...
export function Reviews() {
  ...
  return (
    <div
      className="page-section reviews-page"
